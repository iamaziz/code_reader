...
def config():
    ...
    hide_streamlit_style = """
						...
						"""
    title = """
	<sub>[source code](https://github.com/scikit-learn/scikit-learn)</sub>
	"""
...
# -- scan files
execlude = ("__", "app")
files = [f for f in glob("scikit-learn/sklearn/**/*.py", recursive=True) if not f.startswith(execlude)]
